                ...
                <body class="fixed-header sidebar-right-close sidebar-left-close">
                    ...
                    <div class="container-fluid mt-1 main-container ">
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <div class="col-md-8 col-lg-8 col-xs-12">
                                        <div id="printableArea">
                                            ...
                                            <div class="card-body">
                                                <div class="mb-0 content-color-secondary ml-20">


                                                    <h3 style="text-align: left;">A. Biodata Desa</h3>
                                                    <h5 class="display-5"
                                                        style="text-align: justify; text-indent: 3em; font-weight:200;">
                                            ...
                                            <div class="card-body">
                                                <div class="mb-0 content-color-secondary ml-20">
                                                    <h3 style="text-align: left;">B. Sejarah Desa</h3>
                                                    <h5 class="display-5"
                                                        style="text-align: justify; font-weight:200; text-indent: 3em;">
                                                        {!! $data->sejarah !!}</h5>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <section id="about">
                                <div class="container pb-sm-50 " style="text-align: justify;">
