            ...
            <div class="header-nav">
                    <div class="header-nav-wrapper navbar-scrolltofixed" style="background-color: #fca311 ;">
                        <div class="container">
                            ...
                            <img src="{{ asset('storage/' . $data_user->logo) }}" style="width: 5%; height:6%; margin-left: -67%; margin-top:5px; margin-bottom:5px;">
                        ...
                        <ul class="menuzord-menu">
                                ...
                                <li>
                                    <form action="{{Route('dashwebinput')}}" method="get" class="bg-hover-theme-colored"  style="border-radius:100px; width:100px;">
                                        @csrf
                                        <input type="hidden" value="{{$data_user->id}}" name="id" class="bg-hover-theme-colored" >
                                      
                                            
                                        {{-- @dd($award->user_id) --}}
                                        
                                        
                                        <button class="bg-hover-theme-colored" style="margin:2px 40px 0px 20px;margin-left: 0%;font-weight:550; color:#333333; font-size:13px; font-family: 'Open Sans', sans-serif;width:100px; background-color:#fca311; border-radius:100px;" type="submit"><div style="background-color:#fca311; border-radius:100px;width:90px;"class="bg-hover-theme-colored " >Beranda</div></button>
                                    </form>
                                </li>
                                ...
                                <ul class="dropdown">
                                        ...
                                        {{-- <a href="{{ route('tentangdesa') }}">Tentang Desa</a> --}}
                                            <form action="{{Route('btntentang')}}" method="get">
                                                @csrf
                                                <input type="hidden" value="{{$data_user->id}}" name="id" >
                                                <button style="margin-left: 9%;font-weight: 550; font-size: 13px; font-family: 'Open Sans', sans-serif; color: #585656;" type="submit"><div style="background-color:#fff">Tentang Desa</div></button>
                                            </form>
                                    </li>
                                    ...
                                    <li>
                                        <form action="{{Route('kestdesa')}}" method="get">
                                            @csrf
                                            <input type="hidden" value="{{$data_user->id}}" name="id" >
                                            <button style="margin-left: 9%;font-weight: 550; font-size: 13px; font-family: 'Open Sans', sans-serif; color: #585656;" type="submit"><div style="background-color:#fff">Struktur Desa</div></button>
                                        </form>
                                    </li>
                                </ul>
                            </li>
                                ...
                                <ul class="dropdown">
                                    <li>
                                        <form action="{{Route('kesttaruna')}}" method="get">
                                            @csrf
                                            <input type="hidden" value="{{$data_user->id}}" name="id" >
                                            <button style="margin-left: 9%;font-weight: 550; font-size: 13px; font-family: 'Open Sans', sans-serif; color: #585656;" type="submit"><div style="background-color:#fff">Karang Taruna</div></button>
                                        </form>
                                    </li>
                                    <li>
                                        <form action="{{Route('kepkk')}}" method="get">
                                            @csrf
                                            <input type="hidden" value="{{$data_user->id}}" name="id" >
                                            <button style="margin-left: 9%;font-weight: 550; font-size: 13px; font-family: 'Open Sans', sans-serif; color: #585656;" type="submit"><div style="background-color:#fff">PKK</div></button>
                                        </form>
                                    </li>
                                </ul>
                            <li><a href="#">Data &ensp;</a>
                                <ul class="dropdown">
                                    <li><a class="nav-link {{ Request::is('grafikusia') && Request::is('grafikkelamin') && Request::is('grafikagama')&& Request::is('grafikpendidikan')&& Request::is('grafikperkawinan')? '' : 'collapsed' }} " data-bs-target="#forms-nav"href="#">Dinamika Penduduk</a>
                                        <ul class="dropdown">
                                            <li><li><form action="{{Route('kegu')}}" method="get">
                                                @csrf
                                                <input type="hidden" value="{{$data_user->id}}" name="id" >
                                                <button style="margin-left: 9%;font-weight: 550; font-size: 13px; font-family: 'Open Sans', sans-serif; color: #585656;" type="submit"><div style="background-color:#fff">Grafik Usia</div></button>
                                            </form></li>
                                            <li><form action="{{Route('kejk')}}" method="get">
                                                @csrf
                                                <input type="hidden" value="{{$data_user->id}}" name="id" >
                                               <button style="margin-left: 9%;font-weight: 550; font-size: 13px; font-family: 'Open Sans', sans-serif; color: #585656;" type="submit"><div style="background-color:#fff">Grafik Jenis Kelamin</div></button>
                                            </form></li>
                                            <li><form action="{{Route('keagama')}}" method="get">
                                                @csrf
                                                <input type="hidden" value="{{$data_user->id}}" name="id" >
                                               <button style="margin-left: 9%;font-weight: 550; font-size: 13px; font-family: 'Open Sans', sans-serif; color: #585656;" type="submit"><div style="background-color:#fff">Grafik Agama</div></button>
                                            </form>
                                        </li>
                                        <li><form action="{{Route('kepdd')}}" method="get">
                                            @csrf
                                            <input type="hidden" value="{{$data_user->id}}" name="id" >
                                            <button style="margin-left: 9%;font-weight: 550; font-size: 13px; font-family: 'Open Sans', sans-serif; color: #585656;" type="submit"><div style="background-color:#fff">Grafik Pendidikan</div></button>
                                        </form>
                                    </li>
                                    <li><form action="{{Route('kekawin')}}" method="get">
                                        @csrf
                                        <input type="hidden" value="{{$data_user->id}}" name="id" >
                                        <button style="margin-left: 9%;font-weight: 550; font-size: 13px; font-family: 'Open Sans', sans-serif; color: #585656;" type="submit"><div style="background-color:#fff">Grafik Perkawinan</div></button>
                                    </form>
                                </li>
                                        </ul>
                                    </li>
                                    <li><form action="{{Route('kesarana')}}" method="get">
                                        @csrf
                                        <input type="hidden" value="{{$data_user->id}}" name="id" >
                                        <button style="margin-left: 9%;font-weight: 550; font-size: 13px; font-family: 'Open Sans', sans-serif; color: #585656;" type="submit"><div style="background-color:#fff">Sarana</div></button>
                                    </form>
                                </li>
                                    </li>
                                </ul>
                            ...
                            <li><form action="{{Route('keperaturan')}}" method="get" >
                                @csrf
                                <input type="hidden" value="{{$data_user->id}}" name="id" class="bg-hover-theme-colored"  style="border-radius:100px; width:100px;">
                                <button class="bg-hover-theme-colored" style="margin:2px 40px 0px 20px;margin-left: 0%;font-weight:550; color:#333333; font-size:13px; font-family: 'Open Sans', sans-serif;width:100px; background-color:#fca311; border-radius:100px;" type="submit"><div style="background-color:#fca311; border-radius:100px;width:90px;"class="bg-hover-theme-colored " >Peraturan</div></button>
                            </form>
                        </li>
                            <li style="margin-top: -94px; margin-left: 79%; width: 100%;"><a class="nav-link {{ Request::is('umkmdesa') && Request::is('pariwisatadesa') ? '' : 'collapsed' }} " data-bs-target="#forms-nav" href="#">Potensi Desa &ensp;</a>
                                <ul class="dropdown">
                                    <li><form action="{{Route('keumkm')}}" method="get">
                                        @csrf
                                        <input type="hidden" value="{{$data_user->id}}" name="id" >
                                        <button style="margin-left: 9%;font-weight: 550; font-size: 13px; font-family: 'Open Sans', sans-serif; color: #585656;" type="submit"><div style="background-color:#fff">UMKM</div></button>
                                    </form></li>
                                    <li><form action="{{Route('kepw')}}" method="get">
                                        @csrf
                                        <input type="hidden" value="{{$data_user->id}}" name="id" >
                                        <button style="margin-left: 9%;font-weight: 550; font-size: 13px; font-family: 'Open Sans', sans-serif; color: #585656;" type="submit"><div style="background-color:#fff">Pariwisata</div></button>
                                    </form></li>
                                </ul>
                            </li>
                            <li style="margin-top: -94px; margin-left: 101%; width: 100%"><a class="nav-link {{ Request::is('beritadesa') && Request::is('penghargaandesa') && Request::is('galeridesa')? '' : 'collapsed' }} " data-bs-target="#forms-nav"href="#">Berita &ensp;</a>
                                <ul class="dropdown">
                                    <li><form action="{{Route('keberita')}}" method="get">
                                        @csrf
                                        <input type="hidden" value="{{$data_user->id}}" name="id" >
                                        <button style="margin-left: 9%;font-weight: 550; font-size: 13px; font-family: 'Open Sans', sans-serif; color: #585656;" type="submit"><div style="background-color:#fff">Berita</div></button>
                                    </form></li>
                                    <li><form action="{{Route('kepenghargaan')}}" method="get">
                                        @csrf
                                        <input type="hidden" value="{{$data_user->id}}" name="id" >
                            ...
                            <div class="pull-right flip hidden-sm hidden-xs mt-20 pt-5">
                                <a class="btn" href="{{ route('dashweb') }}" style="background-color:#F26522; color:#fff; border-radius: 10px; margin-left: 90%;"><b>Kembali</b></a>
                               </div>
                               <div class="pull-right flip hidden-sm hidden-xs mt-20 pt-5" style="margin-right: -80px;">
                                @if (auth()->user() && auth()->user()->role == 'admindesa')
                                <a class="btn" href="{{ route('dashboard') }}" style="background-color:#F26522; color:#fff; border-radius: 10px;"><b>Kelola Desa</b></a>
                                @endif
                            </div>
