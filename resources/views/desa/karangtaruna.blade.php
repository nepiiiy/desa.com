...
<body class="">
    <div id="wrapper" class="clearfix">
        ...
        {{-- @dd($profil) --}}
            ...
            <section img src="https://mdbcdn.b-cdn.net/img/new/standard/city/053.webp" class="inner-header divider layer-overlay overlay-dark-8"   >
                    ...
                    <table class=" table-hover mt-3 content-table rtr-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <center><img style="width: 100px;height: 120px; object-fit:cover"
