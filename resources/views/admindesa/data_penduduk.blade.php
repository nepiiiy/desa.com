                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form" method="get" action="{{ route('searchh') }}">
                                ...
                                <button type="submit" class="button-79" style="margin-left: 95%; margin-bottom: -20px;">Cari</button>

                            </form>
                            <a href="/tambahpenduduk"><button class="button-79 mb-3" >Tambah Penduduk</button></a>

                            <a href="{{Route('export')}}"><button class="btn btn-danger btn-sm">Export</button></a>
                                 ...
                                 <div class="modal fade" id="basicModal" tabindex="-1">
                                   <div class="modal-dialog">
                                     <div class="modal-content">
                                       ...
                                       <br>
                                       <input type="file" name="file" class="form-controller ms-2 me-2">

                                       <p style="color:red" class="mb-0">&ensp;&ensp;pastikan isi data sesuai dengan kolomnya</p>
                                       <br>
