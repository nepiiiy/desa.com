                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('upload') }}" method="POST" enctype="multipart/form-data" class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" value="{{ old('judul') }}" name="judul" class="form-control @error('judul') is-invalid @enderror" id="judul" required>
                            </div>
                            <div class="col-12 mb-4">
                                <label for="tanggal" class="form-label fw-bold">Tanggal</label>
                                <input type="date" value="{{ old('tanggal') }}"name="tanggal" class="form-control @error('tanggal') is-invalid @enderror" id="tanggal" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <label>
                                ...
                                <div class="input-group mb-3">
                                    <input type="file" value="{{ old('cover') }}" class="form-control @error('cover') is-invalid @enderror" name="cover" id="cover" required>
                                </div>
                            </label>
