      ...
      <div class="row">
        <div class="col-lg-13 ms-auto me-auto">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title">Data UMKM</h5><a href="{{ route('products.create') }}"><button class="button-79 mb-3" style="font-size: 13px;">Tambah Produk</button></a>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <form action="{{ route('products.destroy',$product->id) }}" method="POST">
                    ...
                    <button type="submit" class="btn btn-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill delete" 
